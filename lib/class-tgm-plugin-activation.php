    ...
    class TGM_Plugin_Activation {
        ...
        public function __construct() {
            ...
            $this->strings = array(
                ...
                'notice_can_install_required'    => _n_noop( 'The Boomtrain Tracker requires the following plugin: %1$s.', 'The Boomtrain Tracker requires the following plugins: %1$s.' ),
                'notice_can_install_recommended' => _n_noop( 'The Boomtrain Tracker recommends the following plugin: %1$s.', 'The Boomtrain Tracker recommends the following plugins: %1$s.' ),
                ...
                'notice_ask_to_update'           => _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with the Boomtrain Tracker: %1$s.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with the Boomtrain Tracker: %1$s.' ),
